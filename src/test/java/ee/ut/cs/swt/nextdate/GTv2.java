...
public class GTv2 {
	...
	public void testCreatesNextDate1() throws Throwable {
	    NextDate nextDate0 = new NextDate(1999, 1999, 1999);
	    String string0 = nextDate0.run(3, 3, 1999);
	    assertEquals("3/4/1999", string0);
	}
	...
	public void testCreatesNextDate13() throws Throwable {
	    ...
	    String string0 = nextDate0.run(1, 2, 2004);
	    assertEquals("1/3/2004", string0);
	}
	...
	public void testCreatesNextDate18() throws Throwable {
	    ...
	    String string0 = nextDate0.run(6, 6, 1829);
	    assertEquals("6/7/1829", string0);
	}
	...
	public void testCreatesNextDate10() throws Throwable {
	    NextDate nextDate0 = new NextDate(2001, 2001, (-38));
	...
	public void testRunWithPositive0() throws Throwable {
	    NextDate nextDate0 = new NextDate(6, 2021, 6);
	    String string0 = nextDate0.run(2021, 1, 31);
	    assertEquals("invalid Input Date", string0);
	}
