...
public class GTv1 {
	...
	public void testCreatesNextDate1() throws Throwable {
	    ...
	    String string0 = nextDate0.run(5, 31, 1802);
	    assertEquals("6/1/1802", string0);
	}
	...
	public void testCreatesNextDate13() throws Throwable {
	    ...
	    String string0 = nextDate0.run(10, 10, 1970);
	    assertEquals("10/11/1970", string0);
	}
	...
	public void testCreatesNextDate11() throws Throwable {
	    NextDate nextDate0 = new NextDate(1, 1, 1);
	    String string0 = nextDate0.run(1, 1, 1819);
	    assertEquals("1/2/1819", string0);
	}
