...
public class GTv12 {
	...
	public void testCreatesNextDate0() throws Throwable {
	    ...
	    String string0 = nextDate0.run(2, 12, 12);
	    assertEquals("invalid Input Date", string0);
	}
	...
	public void testRunWithZeroAndPositive0() throws Throwable {
	    NextDate nextDate0 = new NextDate(2021, 2021, 2021);
	    String string0 = nextDate0.run(311, 0, 2021);
	    assertEquals("invalid Input Date", string0);
	}
	...
	public void testRunWithPositive() throws Throwable {
	    NextDate nextDate0 = new NextDate(2021, 2021, 2021);
	    String string0 = nextDate0.run(311, 2, 311);
	    assertEquals("invalid Input Date", string0);
	}
	...
	public void testCreatesNextDate13() throws Throwable {
	    ...
	    String string0 = nextDate0.run(2, 28, 1989);
	    assertEquals("3/1/1989", string0);
	}
